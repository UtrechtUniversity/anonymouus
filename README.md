...
## Usage
To run the software you take the following steps:
1. Provide the [data](#input-data) to be anonymized
2. Provide the [keyword-replacement mapping](#mapping)
3. Create and customize the [Anonymization object](#anonymization-object)
4. [Anonymize](#anonymize-data) the data
